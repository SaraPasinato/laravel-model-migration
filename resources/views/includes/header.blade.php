<header class="d-flex justify-content-center py-3 bg-dark">
    <ul class="nav nav-pills">
      ...
      <li class="nav-item"><a href="" class="nav-link disabled {{request()->routeIs('travel.show')? 'active': ' '}}">Travels</a></li>
      <li class="nav-item"><a href="#" class="nav-link disabled {{request()->routeIs('transport.show')? 'active': ' '}}">Transports</a></li>
